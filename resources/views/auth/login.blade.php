        ...
        <div class="mt-6">
          <div class="relative">
            ...
            <div class="relative flex justify-center text-sm">
              <span class="px-2 bg-white dark:bg-[#0f161a] text-gray-500">Or continue with</span>
            </div>
          </div>

          <div class="mt-6">
            <a href="{{ route('auth.google') }}"
               class="w-full inline-flex items-center justify-center gap-3 rounded-xl bg-white dark:bg-[#1a242b] border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-white font-semibold py-3 px-6 hover:bg-gray-50 dark:hover:bg-[#232e36] transition-all duration-200 shadow-sm hover:shadow-md">

...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 font-display min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
      ...
      <div class="mt-6 text-center">
        <form action="{{ route('verify.email.resend') }}" method="POST" id="resend-form">
          ...
          <button 
            type="submit"
            class="text-sm font-semibold text-[#1193d4] hover:text-[#0f83bd] transition-colors"
          >
            Resend OTP
          </button>
        </form>

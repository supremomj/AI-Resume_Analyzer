        ...
        <form id="registerForm" action="{{ route('register') }}" method="POST" class="space-y-5">
          ...
          <div class="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl">
            <div class="flex items-start gap-3">
              ...
              <label for="terms" class="flex-1 text-sm text-gray-800 dark:text-gray-200 cursor-pointer leading-relaxed">
                <span class="font-medium">I agree to the</span> 
                <a href="{{ url('/terms') }}" target="_blank" class="text-[#1193d4] hover:text-[#0f83bd] hover:underline font-semibold mx-1 transition-colors">Terms and Conditions</a> 
